...
#ifndef CQ_FRK_FM3_LFCQ1_H_
#define CQ_FRK_FM3_LFCQ1_H_
...
#define CONFIG_MEM_RAM_LEN          (64 * 1024)
#define CONFIG_MEM_RAM_BUF_LEN      (44 * 1024)
#define CONFIG_MEM_MALLOC_LEN       (16 * 1024)
#define CONFIG_MEM_STACK_LEN        (4 * 1024)
/* external SRAM */
#define CONFIG_NR_DRAM_BANKS        1
#define CONFIG_SYS_RAM_BASE         0x62000000
#define CONFIG_SYS_RAM_SIZE         0x00400000
#define CONFIG_SYS_MALLOC_LEN       CONFIG_MEM_MALLOC_LEN
#define CONFIG_SYS_LOAD_ADDR        (CONFIG_SYS_RAM_BASE + 0x80000)
/* Env in flash */
#define CONFIG_ENV_IS_IN_FLASH
#define CONFIG_ENV_SIZE             (8 * 1024)
#define CONFIG_ENV_ADDR             0x00020000
...
#define CONFIG_UBOOT_ON_SDRAM
#define CONFIG_UBOOT_RAM_BASE       0x62000000
#define CONFIG_UBOOT_RAM_LEN        0x60000
#define CONFIG_UBOOT_RAM_BUF_LEN    0x10000
#define CONFIG_UBOOT_MALLOC_LEN     0x10000
#endif
...
#define CONFIG_HOSTNAME         cq-frk-fm3-lfcq1

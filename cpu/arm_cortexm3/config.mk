...
PLATFORM_CPPFLAGS += -DCONFIG_MEM_STACK_LEN=$(CONFIG_MEM_STACK_LEN)
PLATFORM_CPPFLAGS += -DCONFIG_UBOOT_RAM_BASE=$(CONFIG_UBOOT_RAM_BASE)
PLATFORM_CPPFLAGS += -DCONFIG_UBOOT_RAM_LEN=$(CONFIG_UBOOT_RAM_LEN)
PLATFORM_CPPFLAGS += -DCONFIG_UBOOT_RAM_BUF_LEN=$(CONFIG_UBOOT_RAM_BUF_LEN)
PLATFORM_CPPFLAGS += -DCONFIG_UBOOT_MALLOC_LEN=$(CONFIG_UBOOT_MALLOC_LEN)


PLATFORM_CPPFLAGS += -I$(TOPDIR)/cpu/$(CPU)

PLATFORM_RELFLAGS += -mthumb -mcpu=cortex-m3 -fsigned-char -fno-builtin-puts -fno-common -ffixed-r8
